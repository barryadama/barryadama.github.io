...
# 🔗 Profiles
PhD student in Applied Mathematics, specializing in statistical modeling, bayesian optimization, and uncertainty quantification.  
Strong skills in object-oriented programming and R package development.  
Open to full-time opportunities in the field of data science starting from July 2025.
...
- **Plans d’expériences pour la calibration de codes de calculs coûteux**  
  ...
  📍 *Journées de Statistiques de la SFdS, Université de Bordeaux* — 27–31 May 2024

- **Planification d'expériences physiques et numériques pour la calibration de simulateurs**  
  👥 *Adama Barry, François Bachoc, Sarah Bouquet, Miguel Munoz Zuniga, Clémentine Prieur*  
  📍 *Journées CIROQUO, École des Mines de Saint-Étienne* — 14–16 May 2024

- **Planification d'expériences physiques et numériques pour la calibration de simulateurs**  
  👥 *Adama Barry, François Bachoc, Sarah Bouquet, Miguel Munoz Zuniga, Clémentine Prieur*  
  📍 *Journées CIROQUO, Stellantis Poissy* — 23–24 November 2023

- **Plans d'expériences physiques et numériques pour la calibration de codes de calcul coûteux**  
  👥 *Adama Barry, François Bachoc, Sarah Bouquet, Miguel Munoz Zuniga, Clémentine Prieur*  
  📍 *École Thématique sur les Incertitudes en Calcul Scientifique, Lège-Cap-Ferret* — 8–13 October 2023

- **Plans d'expériences physiques et numériques pour la calibration de codes de calcul coûteux**  
  👥 *Adama Barry, François Bachoc, Sarah Bouquet, Miguel Munoz Zuniga, Clémentine Prieur*  
  📍 *GDR-Mascotnum Workshop “Calibration des codes numériques”, IHP Paris* — 31 May 2023

- **Plans d'expériences physiques et numériques pour la calibration de codes de calcul coûteux**  
  👥 *Adama Barry, François Bachoc, Sarah Bouquet, Miguel Munoz Zuniga, Clémentine Prieur*  
  📍 *Journées CIROQUO, INRIA Saclay* — 23–25 May 2023

- **Optimisation bayésienne de code de calculs coûteux**  
  👥 *Adama Barry, François Bachoc, Sarah Bouquet, Miguel Munoz Zuniga, Clémentine Prieur*  
  📍 *RJCAF, IHP Paris* — 5–6 December 2022

- **Planification d'expériences numériques pour la calibration de simulateurs (Bilan des travaux)**  
  👥 *Adama Barry, François Bachoc, Sarah Bouquet, Miguel Munoz Zuniga, Clémentine Prieur*  
  📍 *Journées CIROQUO, BRGM Orléans* — 16–17 November 2022

- **Calibration de code de calculs coûteux**  
  👥 *Adama Barry, François Bachoc, Sarah Bouquet, Miguel Munoz Zuniga, Clémentine Prieur*  
  📍 *Journées CIROQUO, INRIA Grenoble* — 23–25 May 2022
...
- **Plans d'expériences pour la calibration de code de calculs coûteux**  
  👥 *Adama Barry, François Bachoc, Sarah Bouquet, Miguel Munoz Zuniga, Clémentine Prieur*  
