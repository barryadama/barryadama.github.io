...
subtitle: "Fondements, paradigmes et perspectives"
author: "Adama Barry"
date: today
lang: fr
format:
  html:
    ...
    css: |
      ...
      h1, h2, h3 { font-family: 'Helvetica Neue', sans-serif; color: #1a1a2e; }
      h1 { border-bottom: 3px solid #4361ee; padding-bottom: 0.4rem; }
      h2 { border-left: 4px solid #4361ee; padding-left: 0.75rem; }
      blockquote { border-left: 4px solid #adb5bd; background: #f8f9fa; padding: 1rem 1.5rem; border-radius: 4px; font-style: italic; color: #495057; }
      .callout { border-radius: 6px; }
      .definition-box { background: #e8f4f8; border-left: 5px solid #4361ee; padding: 1rem 1.5rem; border-radius: 4px; margin: 1.5rem 0; }
